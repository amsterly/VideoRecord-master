...
//        Camera.Size optimalSize = getOptimalPreviewSize(sizes, w, h);
    ...
    private Bitmap getVideoThumbnail(String filePath) {
        ...
        try {
//            Uri temp=FileProvider.getUriForFile(mContext,"fileprovider",file);
//            retriever.setDataSource(mContext,temp);
...
//            mMediaRecorder.setVideoSize(list.get(0).width, list.get(0).height);
